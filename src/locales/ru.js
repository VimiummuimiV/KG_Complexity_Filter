export const ru = {
    ...
    // Подсказки
    tooltipScore:        'Общая оценка сложности набора (0 = тривиально, 100 = очень сложно)',
    ...
    tooltipWorstZone:    'Худший участок — самый длинный непрерывный сложный сегмент текста',
